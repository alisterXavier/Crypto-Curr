...
function Navbar() {
  ...
  const handleClick = (e) => {
    ...
    selection.current.querySelector(".selected").classList.remove("selected");
  ...
  return (
    <nav className="flex z-10 top-0 sticky">
      <div className="nav-wrapper flex w-full">
        <ul
        ...
        >
          ...
          <li className="flex items-center relative" id="options-sm">
            <a
              onClick={(e) => {
        ...
        <div className="search-container-101 flex items-center justify-between">
          <div className="search-container relative h-full flex items-center justify-center">
            <label className="search-label relative pl-10 h-3/5">
              <input
                type="text"
                ...
                className="search-input-lg relative bg-transparent w-full h-full"
              />
              <div
                className="placeholder absolute flex items-center"
                ref={placeholder}
              >
                <AiOutlineSearch className="mx-1 cursor-pointer" size={20} />
                <p className="">Search Tokens</p>
              </div>
            </label>
            {search && (
              <div className="search flex flex-col justify-start cursor-default">
                <label className="flex w-full h-10 items-center m-3">
                  <TfiAngleLeft
                    size={25}
          ...
          <ul className="flex items-center justify-between" id="second-child">
            <li className="flex items-center relative" id="options-lg">
              <a
                onClick={(e) => {
                  e.currentTarget.parentElement.classList.toggle("active");
                }}
            ...
            <li className="relative text-white font-semibold">
              ...
              >
                Ethereum
                <TfiAngleDown className="ml-2" size={10} />
              </a>
              <ul className="mt-5 w-56 options flex-col justify-evenly items-center">
                <li className="text-white">
                  <a>Ethereum</a>
                </li>
                <li className="text-white">
            ...
            <li>
              <ul className="flex items-center px-2">
                <li className="relative mr-5" id="search-sm">
                  <AiOutlineSearch
                    size={25}
                    className=""
                    onClick={handleSearch}
                  ...
                  {search && (
                    <div className="search flex flex-col justify-start cursor-default">
                      <label className="flex h-10 items-center m-3">
                        <TfiAngleLeft
                          size={20}
                          className="cursor-pointer"
                          onClick={handleSearch}
                ...
                <li className="connect font-semibold flex items-center px-2">
                  <a className="">Connect |</a>
                  <a className="p-0 ml-1 mt-1 h-fit">
